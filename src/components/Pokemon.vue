<template>
  ...
  <div class="flex justify-between items-center sticky top-0 z-30 bg-slate-200/75 px-8 py-4 lg:px-20 shadow-sm w-full mb-20">
      ...
      <div>
          <button @click="toggleModal">
              <p class="px-3 py-2 lg:px-5 lg:py-2 bg-white flex justify-center items-center rounded-full shadow-lg cursor-pointer">
                  <span class="mr-2 text-sm">0 cacth</span>
            ...
            <div class="flex justify-center items-center px-2 py-2 lg:px-4 lg:py-7">
              <div class="w-full">
                <div class="flex justify-center items-center">
                  <h4 class="lg:text-2xl text-lg font-bold text-slate-700">0 Pokemon </h4>
                </div>
                <div class="no-scrollbar h-52 lg:h-80 lg:mt-5 mt-2 sm:mt-3 w-full justify-center items-center">
                  <div class="bg-slate-300 my-2 rounded-lg flex w-full px-4 py-2 gap-2" style="background-color: #e2e8f0bf;">
                    <div>
                      <img src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/1.png" alt="pokemon" class="w-10 lg:w-20">
                    </div>
                    <div class="">
                      <p class="text-xs sm:text-sm lg:text-base">0001</p>
                      <h2 class="text-xs font-semibold sm:text-sm lg:text-xl">bulbasaur</h2>
                    </div>
                  </div>
                  <!-- <div class="text-center font-semibold text-lg text-gray-500"> 
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mb-12 w-9/12">
      <div
